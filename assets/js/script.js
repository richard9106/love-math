...
function runGame(gameType){
  ...
  if(gameType === "addition"){
    ...
    displaySbutractQuestion(num1, num2);
  }
...
function checkAnswer(){
  ...
  if(isCorrect){
    alert("Hey You got is right!!")
    incrementScore();
  }else{
    alert(`Awwwww .... you answered ${userAnswer}, The correct Answer was ${calculateAnswer[0]} `)
...
function calculateCorrectAnswer(){
  ...
  if(operator === "+"){
    ...
    alert(`unimplemented operatot ${operator}`);
...
/***
 * Gets the current tally of Incorrect answer from the DOM and incremets it by 1
 */
...
function displaySbutractQuestion(operand1, operand2){
